...
import appRoutes from './routes/routes.json';
...
import services from './routes/services.json';
...
const BASE_URL_PLACEHOLDER_FOR_FILESYSTEM = '{files}';
/**
 * @returns {Object}
 */
 ...
 * @returns {Object}
 */
const getServices = (rootUrl, fileSystemUrl) =>
    JSON.parse(
        JSON.stringify(services)
            .replace(
                ...
                new RegExp(BASE_URL_PLACEHOLDER_FOR_FILESYSTEM, 'g'),
                fileSystemUrl
            )
    );
